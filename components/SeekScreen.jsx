    ...
    <div className={styles.wrap}>
      ...
      <div className={styles.chips}>
        {CATEGORIES.map(t => (
          <button
            key={t.id}
            className={`${styles.chip} ${topic?.id === t.id ? styles.chipSel : ''}`}
      ...
      <textarea
        ...
        placeholder="Ya apni baat khud likho... jaise: 'Main bahut stressed hoon, kuch samajh nahi aa raha'"
        rows={3}
      />
      ...
      {guidance && (
        <div id="guidance-card" className={`${styles.cardWrap} fade-in`}>
          ...
          <div className={styles.actions}>
            ...
            <button className={styles.actBtn} onClick={handleWhatsApp}>
              💬 WhatsApp
            </button>
